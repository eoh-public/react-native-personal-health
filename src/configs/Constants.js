...
export const TESTID = {
  ...
  ROW_EXIT_PersonalHealth_DRAWER: 'ROW_EXIT_PersonalHealth_DRAWER',
  ROW_ITEM_PersonalHealth_DRAWER: 'ROW_ITEM_PersonalHealth_DRAWER',
  ...
  // SearchBar
  BUTTON_MENU_PersonalHealth: 'BUTTON_MENU_PersonalHealth',
