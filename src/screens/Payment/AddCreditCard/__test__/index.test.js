...
describe('test AddCreditCard container', () => {
  ...
  test('render add credit card start with 4', async () => {
    ...
    const { textCustomerNumber, nonCardType, visaCardType, masterCardType } =
  ...
  test('test input not ready to save do not have cvv', async () => {
    ...
    const instance = tree.root;
    const { itemInputCardNumber, itemInputName, itemInputExpireDate } =
      getElement(instance);
  ...
  test('test input not ready to save expire date', async () => {
    ...
    const instance = tree.root;
    const { itemInputCardNumber, itemInputName, itemInputCVV } =
      getElement(instance);
