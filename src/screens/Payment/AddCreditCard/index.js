...
import { API, Colors, PHConfig } from '../../../configs';
...
import {
  SvgMasterCard,
  SvgMasterCardDisable,
  SvgVisa,
  SvgVisaDisable,
} from '../../../../assets/images/PaymentMethod';
...
const AddCreditCard = memo(({ route }) => {
  ...
  const handleSaveCard = async () => {
    ...
    const config = {
      headers: {
        'Authorization': `Bearer ${PHConfig.stripePublishKey}`,
      ...
      >
        ...
        <View>
          ...
          <View style={styles.flexRow}>
            ...
            >
              {cardType === 'visa' ? <SvgVisa /> : <SvgVisaDisable />}
            </TouchableOpacity>
            ...
            >
              {cardType === 'master_card' ? (
                <SvgMasterCard height={24} width={40} />
              ) : (
                <SvgMasterCardDisable />
              )}
            </TouchableOpacity>
